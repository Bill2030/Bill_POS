<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" style="background-color: #082858;{{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}" id="sidebar">
